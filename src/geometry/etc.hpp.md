...
data:
  ...
  bundledCode: "#line 1 \"src/geometry/etc.hpp\"\n// 1: a-b\u304B\u3089\u898B\u3066\
    ...
    \ Line& l) { return 2.0 * projection(p, l) - p; }     // 65ba76\nbool isinterPL(const\
    \ Point& p, const Line& l) { return abs(p - projection(p, l)) < EPS; }  // e9d393\n\
  ...
  code: "// 1: a-b\u304B\u3089\u898B\u3066a-c\u304C\u53CD\u6642\u8A08\u56DE\u308A\
    ...
    \ abs(p - projection(p, l)) < EPS; }  // e9d393\nbool isinterPS(const Point& p,\
    \ const Line& s) { return ccw(s[0], s[1], p) == 0; }          // 79c17b\nbool\
    \ isinterLL(const Line& l, const Line& m) {\n   return abs(cross(l[1] - l[0],\
    ...
    \ Point& p, const Line& l) { return abs(p - projection(p, l)); }  // c77772\n\
